...
public class LocationPickerActivity extends AppCompatActivity implements LocationProvider.LocationCallback, OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                Intent intent = new Intent(LocationPickerActivity.this, SearchMapActivity.class);
