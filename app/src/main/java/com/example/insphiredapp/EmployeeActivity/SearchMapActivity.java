...
import com.example.insphiredapp.Adapter.GooglePlaceAdapter;
import com.example.insphiredapp.Api_Model.GooglePlaceModel;
import com.example.insphiredapp.Classes.RecyclerTouchListener;
    ...
    public class GooglePlaces extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                //String components = "&components=country:ph";
