package com.example.insphiredapp;
...
*/
    ...
    public void bigPicNotification(Map<String, String> dataMap) {
        ...
        try {
            ...
            style.bigPicture(Glide.with(MyFirebaseMessagingService.this).asBitmap().load(imageUrl).submit().get());
    ...
    public void notificationActions(Map<String, String> dataMap) {
        ...
        Intent intent1 = new Intent(MyFirebaseMessagingService.this, NotificationActivity.class);
        PendingIntent pendingIntent = PendingIntent.getActivity(MyFirebaseMessagingService.this, 0, intent1, PendingIntent.FLAG_UPDATE_CURRENT);
        ...
        builder3.setSmallIcon(R.drawable.ic_baseline_notifications_active_24)
                .setContentTitle(title)
                .setContentText(message)
                .setColor(Color.BLUE)
                .setSound(defaultSoundUri)
    ...
    public void directReply(Map<String, String> dataMap) {
        ...
        Intent feedbackIntent = new Intent(MyFirebaseMessagingService.this, NotificationReceiver.class);
        PendingIntent feedbackPendingIntent = PendingIntent.getBroadcast(MyFirebaseMessagingService.this,
        ...
        builder4.setSmallIcon(R.drawable.ic_baseline_notifications_active_24)
                .setContentTitle(title)
                .setContentText(message)
                .setAutoCancel(true)
                .setSound(defaultSoundUri)
    ...
    public void messageTypeNotification(Map<String, String> dataMap) {
        ...
        builder6.setSmallIcon(R.drawable.ic_baseline_notifications_active_24)
                .setColor(Color.RED)
